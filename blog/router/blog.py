...
@router.post('/blog1', status_code= status.HTTP_201_CREATED , tags=['blogs'])
...
@router.put('/blogUpdate/{id}', status_code=status.HTTP_202_ACCEPTED , tags=['blogs'])
...
@router.get('/get-blogs-by-id/{id}' , status_code=200, response_model=schemas.ShowBlog ,tags=['blogs'] )
